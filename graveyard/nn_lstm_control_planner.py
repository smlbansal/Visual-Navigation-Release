...
class NNLSTMControlPlanner(NNPlanner):
    ...
    def optimize(self, start_config):
        ...
        nn_output_112k, hidden_state, cell_state  = model.predict_nn_output_with_postprocessing(processed_data['inputs'],
                                                                     is_training=False)[:, None]
        # TODO: update the hidden and cell state
        # TODO: Add a way to reset the hidden and cell states
