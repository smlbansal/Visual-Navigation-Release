...
def create_params():
    ...
    p.data_processing.input_processing_function = 'resnet50_keras_preprocessing_with_distortion'
    ...
    p.trainer.ckpt_path = '/home/ext_drive/somilb/data/sessions/sbpd/rgb/uniform_grid/nn_waypoint/resnet_50_v1/session_2019-01-18_12-19-37/checkpoints/ckpt-8'
