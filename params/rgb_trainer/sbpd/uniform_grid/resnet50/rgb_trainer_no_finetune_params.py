...
def create_params():
    ...
    simulator_params.obstacle_map_params.renderer_params.camera_params.width = 224
    simulator_params.obstacle_map_params.renderer_params.camera_params.height = 224
    ...
    # -1 = last cnn layer
    p.model.arch.resnet_output_layer = -1

    # Parameters for the 2d convolution used for dimensionality reduction 
    p.model.arch.dim_red_conv_2d = DotMap(use=False,
                                          stride=2,
                                          filter_size=3,
                                          num_outputs=64,
                                          padding='valid')
