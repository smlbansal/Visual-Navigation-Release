...
file_folder = '/home/ext_drive/somilb/data/training_data/sbpd/sbpd_projected_grid_corrected_last_step'
area_name = 'area5a'
num_files = 70
new_file_folder = '/home/ext_drive/somilb/data/training_data/sbpd/sbpd_projected_grid_include_last_step_successful_goals_only'
    ...
    for j in range(num_files):
        ...
        if filter_timeout_episodes:
            ...
            assert data['vehicle_state_nk3'].shape[0] == \
                   data['episode_number_n1'].shape[0] - number_of_timeout_episodes * (trajectory_segments_per_episode-1) + number_of_successful_episodes
