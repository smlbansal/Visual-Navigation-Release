...
from models.visual_navigation.rgb.resnet50.rgb_resnet50_image_waypoint_model import RGBResnet50ImageWaypointModel
import os
...
class RGBImageWaypointTrainer(VisualNavigationTrainer):
    ...
    """
    simulator_name = 'RGB_Resnet50_NN_Image_Waypoint_Simulator'

    def create_model(self, params=None):
        self.model = RGBResnet50ImageWaypointModel(self.p)
    ...
    def _summary_dir(self):
        ...
        summaries
        """
        return os.path.join(self.p.session_dir, 'summaries', 'nn_image_waypoint')
